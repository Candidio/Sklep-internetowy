...
class appProdProjectContainer extends Container
{
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        return $this->services['doctrine.dbal.default_connection'] = ${($_ = isset($this->services['doctrine.dbal.connection_factory']) ? $this->services['doctrine.dbal.connection_factory'] : $this->services['doctrine.dbal.connection_factory'] = new \Doctrine\Bundle\DoctrineBundle\ConnectionFactory(array())) && false ?: '_'}->createConnection(array('driver' => 'pdo_mysql', 'host' => '127.0.0.1', 'port' => '', 'dbname' => 'petshop', 'user' => 'root', 'password' => 'admin1', 'charset' => 'UTF8', 'driverOptions' => array(1002 => 'SET sql_mode=(SELECT REPLACE(@@sql_mode,\'ONLY_FULL_GROUP_BY\',\'\'))'), 'serverVersion' => 5.1, 'defaultTableOptions' => array()), new \Doctrine\DBAL\Configuration(), $a, array('enum' => 'string'));
    }
    ...
    {
        return $this->services['fragment.listener'] = new \Symfony\Component\HttpKernel\EventListener\FragmentListener(${($_ = isset($this->services['uri_signer']) ? $this->services['uri_signer'] : $this->services['uri_signer'] = new \Symfony\Component\HttpKernel\UriSigner('zg0CusxSYkw3WuSz99IidzznIhO4sNvhsXagurAvcIfRwEuA0614FgQG')) && false ?: '_'}, '/_fragment');
    }
    ...
    {
        return $this->services['uri_signer'] = new \Symfony\Component\HttpKernel\UriSigner('zg0CusxSYkw3WuSz99IidzznIhO4sNvhsXagurAvcIfRwEuA0614FgQG');
    }
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'secret' => 'zg0CusxSYkw3WuSz99IidzznIhO4sNvhsXagurAvcIfRwEuA0614FgQG',
            'ps_caching' => 'CacheMemcache',
            'ps_cache_enable' => false,
            'ps_creation_date' => '2018-10-17',
            'locale' => 'pl-PL',
            'cookie_key' => 'WCoUGB5hwx3WycmTFgyrRo64EXHTW14j75taTXHwd5VtPkvtwPONqc64',
            'cookie_iv' => 'dFH12KEL',
            'new_cookie_key' => 'def000002541193a548948dd94733a4764eef0feb9c6005c3dafa97d0157584edac8b2c020ec2bf0851d4286362e7ca467bac2d1ed95f0e64404c74f99cb7a5f9d5226f4',
            'cache.driver' => 'array',
            ...
            'kernel.secret' => 'zg0CusxSYkw3WuSz99IidzznIhO4sNvhsXagurAvcIfRwEuA0614FgQG',
